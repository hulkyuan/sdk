...
import JinggaoSvg from './icon/jinggao';
            ...
            <div className="document-compare">
                {
                    (allData && allData.length > 0) ?
                                            ...
                                            return (
                                                <div key={refInx}>
                                                    <div className="line">
                                                        ...
                                                        {
                                                            ref.msg &&
                                                            <span className="jinggaoCss"><i dangerouslySetInnerHTML={{ __html: JinggaoSvg }} />{ref.msg}</span>
                                                        }
                                                    </div>
                                                    {
                                                        ref.lineInfos &&
                        ...
                        :
                        <div style={{ fontSize: '16px', textAlign: 'center', marginTop: '10px', letterSpacing: '5px' }}>暂无数据</div>
                }
            </div>
        );
    }
